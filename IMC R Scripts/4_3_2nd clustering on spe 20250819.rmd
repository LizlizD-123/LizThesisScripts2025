...
spee <- spe |>
  mutate(final_cluster = case_when(
    ...
    population_name_NKs_adipo == "NK" ~ "NK/Innate Lymphocytes", 
    B_cell_parent_cluster == "follicular" ~ "Follicular B cell",
    B_cell_parent_cluster ==  "extrafollicular" ~ "Extrafollicular B cell",
    Cluster_APC_final == "pDC" ~ "pDC",
    Cluster_APC_final == "Langerin+ cDC2" ~ "Langerin+ cDC2", 
    Cluster_APC_final == "cDC2" ~ "cDC2", 
    Cluster_APC_final == "CD169- macs" ~ "CD169- macs", 
    Cluster_APC_final == "cDC1" ~ "cDC1", 
