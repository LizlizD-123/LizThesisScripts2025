...
def cellpose = Cellpose2D.builder( pathModel )
        .pixelSize( 0.3250 )                  // Resolution for detection in um
        .channels(  '365/450_40')	               // Select detection channel(s)
...
//        .cellposeChannels( 1,2 )           // Overwrites the logic of this plugin with these two values. These will be sent directly to --chan and --chan2
 //       .cellprobThreshold( 0.8)          // Threshold for the mask detection, defaults to 0.0
//        .flowThreshold( 0.517 )              // Threshold for the flows, defaults to 0.4
...
//        .addParameter( "anisotropy", "3" ) // Any parameter from cellpose or omnipose not available in the builder.
       .cellExpansion( 2.2 )              // Approximate cells based upon nucleus expansion
